...
**Aplicación:** OSSN Demo (demo.opensource-socialnetwork.org) | **Autora:** Adriana Martínez | **Fecha:** Marzo 2026 | **Versión:** 2.0
...
### Detalle de tests automatizados (23 tests en 9 archivos)
...
| `tests/profile/edit-profile.spec.ts` | `authenticated` | 2 | TC-09 |
| **Total** | | **23** | |
